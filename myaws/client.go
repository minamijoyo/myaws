...
func NewClient(stdin io.Reader, stdout io.Writer, stderr io.Writer, profile string, region string, timezone string, humanize bool, format string) (*Client, error) {
	session := session.New()
